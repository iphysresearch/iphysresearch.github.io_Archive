...
在上面这个图里，我会展示几个不同的高斯分布噪声，我把它运行到 CIFAR-10 分类器上看结果。用粉色框标出的是分类器觉得那里有点什么东西的地方。我等下回来再来说明这意味着什么。黄色框标出的地方是一个 FGSM 成功地让模型认为，它看上去是一架飞机。我选了飞机类，因为这个分类成功率最低的几个之一，大概有 25% 的正确了
